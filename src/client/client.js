...
async function send() {
  ...
  if ("serviceWorker" in navigator) {
    ...
    // The subscribe method returns a subscription object. This object contains the endpoint (generated by the browser) to which the push notifications should be sent, it is
    // unique to the users device and browser.
